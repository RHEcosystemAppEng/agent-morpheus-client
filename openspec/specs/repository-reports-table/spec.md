...
- **AND** when the user clears the Finding filter (no value selected), the table SHALL request data without finding-based status or exploitIntelligence Status filter parameters
