...
class NewRpmReportRestTest {
    ...
    private static final String VALID_CVE = "CVE-2024-88888";
    ...
    void acceptedReportHasRpmCheckerInputAndNormalizedCve() {
        ...
        RestAssured.given()
            ...
            .body("report.input.image.target_package.name", equalTo("bash"))
            .body("report.input.image.target_package.version", equalTo("5.2"))
            .body("report.input.image.target_package.release", equalTo("1.el9"))
            .body("report.input.image.target_package.arch", equalTo("x86_64"))
            .body("report.input.image.target_package.ecosystem", equalTo("rpm"))
            .body("report.input.scan.vulns[0].vuln_id", equalTo("CVE-2024-88888"));
    }
    ...
    void missingCveIdKeyReturns400() {
        ...
        body.put("name", "bash");
        body.put("version", "5.2");
        body.put("release", "1.el9");
