...
public class CredentialStoreService {
    ...
    public CredentialStoreService(
        @ConfigProperty(name = "exploit-intelligence.queue.timeout") Duration timeout,
        @ConfigProperty(name = "exploit-intelligence.credential-store.encryption-key") String encryptionKey) {
