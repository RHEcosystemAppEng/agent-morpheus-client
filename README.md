...
In the _Request Analysis_ tab, you will access a form where you can load a CycloneDX SBOM and enter a CVE to inspect. The `user name` will be automatically added as a metadata parameter.
